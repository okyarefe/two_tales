    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Turn your creative ideas into structured language lessons in seconds
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16 relative">
        ...
        <div className="hidden lg:block absolute top-12 left-[12%] right-[12%] h-0.5 bg-gradient-to-r from-accent/20 via-accent/60 to-accent/20 -z-10" />

        {/* Step 1: Create */}
        <div className="flex flex-col h-full bg-card p-6 rounded-xl shadow-sm border border-accent/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          <div className="w-14 h-14 mx-auto mb-6 bg-accent/5 rounded-full flex items-center justify-center text-2xl border-2 border-accent/20 shadow-sm z-10">
            ✨
          </div>
        ...
        <div className="flex flex-col h-full bg-card p-6 rounded-xl shadow-sm border border-accent/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm font-semibold text-gray-800">Master</p>
                <p className="text-xs text-gray-500">
      ...
      {/* Features Highlight */}
      <div className="bg-gradient-to-r from-accent/5 to-marigold-100 rounded-lg p-8 text-center">
