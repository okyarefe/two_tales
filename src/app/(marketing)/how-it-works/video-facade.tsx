...
export default function VideoFacade() {
  ...
  if (isPlaying) {
    return (
      <div className="aspect-video w-full max-w-4xl mx-auto rounded-lg shadow-lg overflow-hidden">
        <iframe
          src="https://www.youtube.com/embed/3dAbsgLJC-k?autoplay=1"
          title="TwoTales — How it works"
          frameBorder="0"
          allowFullScreen
          allow="autoplay"
  ...
  return (
    <button
      onClick={handlePlay}
      className="aspect-video w-full max-w-4xl mx-auto rounded-lg shadow-lg flex items-center justify-center border-2 border-accent/30 hover:border-accent/60 transition-all cursor-pointer group relative overflow-hidden"
    ...
    >
      ...
      <div className="relative text-center p-8 z-10 bg-black/50 rounded-lg">
        <div className="w-20 h-20 mx-auto mb-4 bg-accent rounded-full flex items-center justify-center group-hover:bg-brick-700 group-hover:scale-110 transition-all">
          <svg
