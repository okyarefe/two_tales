  ...
  try {
    ...
    return (
      <div className="container mx-auto max-w-3xl py-8">
        <h1 className="text-2xl font-semibold mb-4">Listen to the story and rewrite it</h1>
  ...
  return (
    <div className="container mx-auto max-w-3xl py-8 space-y-8">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold">Listen to the story and rewrite it</h1>
        <Button variant="outline" size="sm" asChild>
          <Link href="/stories">Back</Link>
        </Button>
      </div>
