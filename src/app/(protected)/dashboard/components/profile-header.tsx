  ...
  return (
    <Card className="hover:translate-y-0">
      <CardContent className="flex flex-col sm:flex-row items-center gap-6">
        <Avatar className="size-20 border-2 border-accent/30">
          {avatarUrl && <AvatarImage src={avatarUrl} alt={displayName} />}
          <AvatarFallback className="text-xl font-semibold bg-accent/10 text-accent">
            {initials}
          </AvatarFallback>
        </Avatar>
        ...
        <div className="flex-1 text-center sm:text-left space-y-2">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            ...
            {userData?.membershipType && (
              <Badge className="bg-accent/10 text-accent border-accent/30 capitalize self-center">
