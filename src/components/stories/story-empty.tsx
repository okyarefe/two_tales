  ...
  return (
    ...
    >
      <div className="relative">
        <div className="absolute inset-0 bg-accent/10 rounded-full scale-150 blur-xl opacity-50 animate-pulse" />
        {isSearch ? (
          <SearchX className="w-16 h-16 text-ink-400 relative z-10" />
        ) : (
          <BookPlus className="w-16 h-16 text-accent relative z-10" />
        )}
      </div>
